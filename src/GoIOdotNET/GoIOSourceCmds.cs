...
namespace GoIOdotNET
{
	class GoIOSourceCmds
	{
		...
		public struct GoIOGetStatusCmdResponsePayload
		{
			...
			/// <summary>
			/// ((status & GO_MOTION_MASK_STATUS_BATTERY_STATE) == GO_MOTION_MASK_STATUS_BATTERY_STATE_GOOD) => good batteries.
			/// </summary>
			public const byte GO_MOTION_MASK_STATUS_BATTERY_STATE_GOOD = 0;
			/// <summary>
			/// ((status & GO_MOTION_MASK_STATUS_BATTERY_STATE) == GO_MOTION_MASK_STATUS_BATTERY_STATE_LOW_WHILE_SAMPLING) 
			/// => marginal batteries.
			/// </summary>
			public const byte GO_MOTION_MASK_STATUS_BATTERY_STATE_LOW_WHILE_SAMPLING = 4;
			/// <summary>
			/// ((status & GO_MOTION_MASK_STATUS_BATTERY_STATE) == GO_MOTION_MASK_STATUS_BATTERY_STATE_LOW_ALWAYS) 
			/// => bad batteries.
			/// </summary>
			public const byte GO_MOTION_MASK_STATUS_BATTERY_STATE_LOW_ALWAYS = 8;
			/// <summary>
			/// ((status & GO_MOTION_MASK_STATUS_BATTERY_STATE) == GO_MOTION_MASK_STATUS_BATTERY_STATE_MISSING) 
